...
import { EventRulesLambdaClientV1 } from '../../src/version1/EventRulesLambdaClientV1';

suite('EventRulesLambdaClient', ()=> {
    ...
    let client: EventRulesLambdaClientV1;
    let fixture: EventRulesClientFixtureV1;

    setup((done) => {
        client = new EventRulesLambdaClientV1();
