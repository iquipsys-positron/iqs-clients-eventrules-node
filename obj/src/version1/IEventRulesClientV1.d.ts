...
export interface IEventRulesClientV1 {
    ...
    getEventRuleById(correlationId: string, rule_id: string, callback: (err: any, rule: EventRuleV1) => void): void;
    ...
    deleteEventRuleById(correlationId: string, rule_id: string, callback: (err: any, rule: EventRuleV1) => void): void;
